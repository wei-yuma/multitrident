...
class multitridentRefineDet(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, ARM, TRM, num_classes, branch, fpn):
        ...
        if phase == 'test':
            ...
            self.detect = Detect_multitridentRefineDet(num_classes, self.size, 0, 1000, 0.01, 0.45, 0.01, 200)
...
def tridentbranch():
    ...
    branch_for_arm0 = [
                           ...
                           # nn.Conv2d(256, 256, kernel_size=3, padding=1, dilation=1),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, dilate=1),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, dilate=1),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, dilate=1),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, dilate=1),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, dilate=1),
                           ...
                           # nn.Conv2d(512, 256, kernel_size=1),
                           # nn.Conv2d(256, 256, kernel_size=3, padding=3, dilation=3),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, padding=1, dilate=1),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, padding=2, dilate=2),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, padding=3, dilate=3),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, padding=3, dilate=3),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, padding=3, dilate=3),

                           # nn.Conv2d(512, 256, kernel_size=1),
                           # nn.Conv2d(256, 256, kernel_size=3, padding=5, dilation=5),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, padding=1, dilate=1),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, padding=2, dilate=2),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, padding=5, dilate=5),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, padding=5, dilate=5),
                           Bottleneck(inplanes=256, planes=64, stride=1, downsample=None, padding=5, dilate=5),
                           ]
    branch_for_arm1 = [
