...
# from models.deform_refinedet  import build_refinedet
...
parser.add_argument('--trained_model',
                    default='weights/experiment/320*320/RefineDet320_VOC_310000.pth', type=str,
                    help='Trained state_dict file path to open')
parser.add_argument('--save_folder', default='eval/', type=str,
                    help='File path to save results')
parser.add_argument('--confidence_threshold', default=0.00, type=float,
