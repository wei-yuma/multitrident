...
from ..box_utils import match, log_sum_exp, soft_refine_match


class softRefineDetMultiBoxLoss(nn.Module):
    ...
    def forward(self, predictions, targets):
        ...
        _, af_predictions = predictions
        af_loc_data, af_conf_data = af_predictions
        ...
        #     if self.use_ARM:
        #         soft_refine_match(self.threshold, truths, defaults, self.variance, labels,
